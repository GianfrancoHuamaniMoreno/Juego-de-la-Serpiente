...
pygame.display.set_caption("Juego creado por Gianfranco del Piero")
game_speed = 10
...
def display_pause_screen():
    text_upper = 'Juego en Pausa!'
    text_lower = 'Press "spacio" to continue.'
...
def display_game_over():
    ...
    text_middle = f'Tú score: {state.points}.'
    text_lower = '¿Quieres seguir jugando? (y/n)'
